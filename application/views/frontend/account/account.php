                        ...
                        <ul>
                          ...
                          <li class="total-wrap">
                           ...
                           <?php if(!$value->order_status > '5'){ ?> 
                            <?php } ?>
                            <a href="javescript:;" data-n="<?=$value->order_status?>" data-href="<?=base_url().'orders/cancle_order/'.$this->utility->safe_b64encode($value->id)?>" class="cncOrder btn btn-orange">Cancel Order</a>
