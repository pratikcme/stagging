...
RESPONSIVE CSS FOR 1200 PX
RESPONSIVE CSS FOR 992 PX
RESPONSIVE CSS FOR 767 PX
RESPONSIVE CSS FOR 575 PX
RESPONSIVE CSS FOR 530 PX
RESPONSIVE CSS FOR 500 PX
RESPONSIVE CSS FOR 475 PX
RESPONSIVE CSS FOR 450 PX
RESPONSIVE CSS FOR 425 PX
...
.category-menu-wrapper.sub-cat-menu ul.sub-cat-main{
	white-space: nowrap;
	overflow-x: scroll;

}

.category-menu-wrapper.sub-cat-menu ul.sub-cat-main::-webkit-scrollbar {
	height: 7px;     
  	width: 5px;
}


.category-menu-wrapper.sub-cat-menu ul.sub-cat-main::-webkit-scrollbar-track {
  background: #e1eaf4;
  height: 5px;
}

.category-menu-wrapper.sub-cat-menu ul.sub-cat-main::-webkit-scrollbar-thumb {
...
@media (max-width: 450px){
	...
	.cart-view-wrap .view-cart-btn-wrapper .btn {
		width: 120px;
		height: 40px;
	}
...
@media (max-width: 425px){
   ...
   .mobile-login-user{
	...
	.social-btns .facebook-btn ,.social-btns .google-btn{
		margin-top: 15px;
	}
	.register-form p {
		margin-top: 15px;
...
@media (max-width: 375px){
	...
	.product-detail-wrapper .order-btn button{
		width: 100%;
	}
